...
def run(traSMAPy: TraSMAPy):
    ...
    # setup custom route
    route2 = traSMAPy.users.createRouteFromEdges("r_2", [e40, e58])
    ...
    #     v0 = traSMAPy.users.createVehicle(f"vehicle{i+1}", route2, defaultVehicle)
    #     v1 = traSMAPy.users.createVehicle(f"vehicle{i+2}", route2, evehicleType)
